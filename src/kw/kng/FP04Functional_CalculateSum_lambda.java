...
public class FP04Functional_CalculateSum_lambda
{
	...
	{
		System.out.println("------------------------------------------------------------------------------");
		System.out.println("Retrive the SUM Result using lambda: ");
		int sum = numbers.stream()
					   .reduce(0, (x,y)->x+y);//0+12,12+9,21+3....
				
			System.out.println("The Result of SUM is  using lambda:" + sum);
	...
	{
		System.out.println("------------------------------------------------------------------------------");
		System.out.println("Retrive the SUB Result using lambda: ");
		int sub = numbers.stream()
					   .reduce(0,(x,y)->x-y);//0-12,-12-9,-21-3....
				
		System.out.println("The Result of SUB is  using lambda:" + sub);
	...
	{
		System.out.println("------------------------------------------------------------------------------");
		System.out.println("Retrive the MIN Result using predfined func: ");
